...
class CODE_AN_UnitCostsRIGID(models.Model):
    ...
    code = models.IntegerField(null=True, blank=True, db_column='code')
    perunitcost = models.FloatField(null=True, blank=True, db_column='perUnitcost')
    rehunitcost = models.FloatField(null=True, blank=True, db_column='rehUnitcost')
